...
-		page = requests.get('http://www.fangraphs.com/leaders.aspx?pos=all&stats=pit&lg=all&qual=0&type=8&season=2016&month=0&season1=2016&ind=0&team={}&rost=0&age=0'.format(team_id[team]))
...
-	page = requests.get('http://www.fangraphs.com/leaders.aspx?pos=all&stats=bat&lg=all&qual=0&type=1&season=2016&month=0&season1=2016&ind=0&team={},ts&rost=0&age=0&filter=&players=0'.format(team_id[team]))
...
-	page = requests.get('http://www.fangraphs.com/leaders.aspx?pos=all&stats=bat&lg=all&qual=0&type=1&season=2016&month=2&season1=2016&ind=0&team={},ts&rost=0&age=0&filter=&players=0'.format(team_id[team]))
...
-	page = requests.get('http://www.fangraphs.com/leaders.aspx?pos=all&stats=rel&lg=all&qual=0&type=8&season=2016&month=0&season1=2016&ind=0&team={},ts&rost=0&age=0&filter=&players=0'.format(team_id[team]))
...
-team1 = raw_input("Enter the home team: ").lower()


-pitcher1 = raw_input("Enter the home team pitcher: ").lower()


-print " "


-team2 = raw_input("Enter the away team: ").lower()


-pitcher2 = raw_input("Enter the home away pitcher: ").lower()
...
-players_pitching(pitcher1, team1)


-players_pitching(pitcher2, team2)
...
-players_pitching_last30(pitcher1, team1)


-players_pitching_last30(pitcher2, team2)
...
-offensive_stats(team1)


-offensive_stats(team2)
...
-offensive_stats_last14(team1)


-offensive_stats_last14(team2)
