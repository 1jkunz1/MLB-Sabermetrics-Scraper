...
class FangraphsScraper(object):
	...
	def get_probable_pitchers():
		...
		while i < 35:
			page = requests.get(
				'http://www.fangraphs.com/leaders.aspx?pos=P&stats=pit&lg=all&qual=0&type=8&season=2018&month=0&season1=2018&ind=0&team=0&rost=0&age=0&filter=&players=p2018-05-28&page=1_30')
	...
	def players_pitching_last30(self, pitcher, team):
		i = 0

		while i < 21:

			page = requests.get(
				'http://www.fangraphs.com/leaders.aspx?pos=all&stats=pit&lg=all&qual=0&type=8&season=2018&month=3&season1=2018&ind=0&team={}&rost=0&age=0'.format(
					self.team_id[team]))
			tree = html.fromstring(page.content)
	...
	def offensive_stats(self, team):
		page = requests.get(
			'http://www.fangraphs.com/leaders.aspx?pos=all&stats=bat&lg=all&qual=0&type=1&season=2018&month=0&season1=2018&ind=0&team={},ts&rost=0&age=0&filter=&players=0'.format(
				team_id[team]))
		tree = html.fromstring(page.content)
	...
	def offensive_stats_last14(self, team):
		page = requests.get(
			'http://www.fangraphs.com/leaders.aspx?pos=all&stats=bat&lg=all&qual=0&type=1&season=2018&month=2&season1=2018&ind=0&team={},ts&rost=0&age=0&filter=&players=0'.format(
				team_id[team]))
		tree = html.fromstring(page.content)
	...
	def bullpen_stats(self, team):
		page = requests.get(
			'http://www.fangraphs.com/leaders.aspx?pos=all&stats=rel&lg=all&qual=0&type=8&season=2018&month=0&season1=2018&ind=0&team={},ts&rost=0&age=0&filter=&players=0'.format(
				team_id[team]))
		tree = html.fromstring(page.content)
